 <div class="content">
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-12">
              <form id="RangeValidation" class="form-horizontal" action="<?= base_url('update-coupon/'.$singleRecord['id']);?>" method="post">
                <div class="card ">
                  ...
                  <div class="card-body ">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-7">
                        <div class="row form-group form-md-line-input form-md-floating-label">
                             <input type="text" class="form-control" value="<?php echo $singleRecord['validFrom']; ?>" autocomplete="off" name="validFrom" id="dt1" readonly required>
                     ...
                     <div class="row">
                      ...
                      <div class="col-sm-7">
                        <div class="row form-group form-md-line-input form-md-floating-label">
                             <input type="text" class="form-control" value="<?php echo $singleRecord['validTo']; ?>" autocomplete="off" name="validTo" id="dt2" readonly required>
                    ...
                    <div class="row">
                      <label class="col-sm-2 col-form-label">Discount Code <span class="error_msg">*</span> </label>
                        <div class="form-group" style="position: relative;">
                          <input type="text" class="form-control" name="code" value="<?= $singleRecord['code'];?>" required/>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-7">
                        <div class="form-group">
                          <input class="form-control" type="text" name="value" required="required"  value="<?= $singleRecord['value'];?>" onkeypress="return isNumber(event)" maxlength="2"/>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-7">
                        <div class="form-group">
                          <input class="form-control" type="text" name="no_of_times" required="required"  value="<?= $singleRecord['no_of_times'];?>" onkeypress="return isNumber(event)" maxlength="3"/>
