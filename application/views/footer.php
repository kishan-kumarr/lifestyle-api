...
<!-- ************************* Data Table with search option **************************************-->
   <script>
    ...
    $('#datetimepicker1').datetimepicker({format: 'HH:mm'}); // timepicker
    </script>
 <!-- ********************************** End Data Table **********************************************-->
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB_G-gIHvseJvUe28r6DBGkuzJiRln-p1M&libraries=places&callback=initAutocomplete"
        async defer></script>
<!-- *************** google location api ******************************* -->
   </body>
</html>
