 <div class="content">
        <div class="container-fluid">
          <div class="row">
               <div class="col-md-12">
              <form id="RangeValidation" class="form-horizontal" action="<?= base_url('add-city');?>" method="post">
                <div class="card ">
                  ...
                  <div class="card-body ">
                   ...
                   <div class="row">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-7">
                        <div class="form-group">
                          <input class="form-control" type="text" name="cityName"  required="required"  value="<?= set_value('cityName');?>"/>
