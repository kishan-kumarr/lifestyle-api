 <div class="content">
        <div class="container-fluid">
          <div class="row">
               <div class="col-md-12">
              <form id="RangeValidation" class="form-horizontal" action="<?= base_url('add-driver');?>" method="post" enctype="multipart/form-data">
                <div class="card ">
       ...
       <!--********************** driver personal details ***************************************** -->
                   <div class="row">
                    ...
                    <div class="row">
                      <label class="col-sm-2 col-form-label">Mobile Number <span class="error_msg">*</span></label>
                      <div class="col-sm-7">
                    ...
                    <div class="col-sm-7">
                      ...
                      <div class="col-sm-7">
                        <div class="form-group">
                         <div class="col-lg-8 col-md-8 col-sm-1">
                         <!--  <div class="dropdown bootstrap-select show"> -->
                            <select class="selectpicker" id="branch"  data-style="select-with-transition" title="Select Branch"  name="branch" required="required" value="<?= set_value('branch')?>">
                                   <?php
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-7">
                        <div class="form-group">
                         <div class="col-lg-8 col-md-8 col-sm-1">
                        <!--   <div class="dropdown bootstrap-select show"> -->
                            <select class="selectpicker"  data-style="select-with-transition" title="Select Branch Manager" id="branchManager"  name="branchManager" required="required" value="<?= set_value('branchManager')?>">
                              </select>
      ...
      <!--********************** driver Vehicle details ***************************************** -->
                    ...
                    <div class="col-sm-7">
                      <div class="form-group">
                       <div class="col-lg-8 col-md-8 col-sm-1">
                      <!--   <div class="dropdown bootstrap-select show"> -->
                          <select class="selectpicker"  data-style="select-with-transition" title="Select Vehicle Type"  name="vehicleType" required="required" id="vehicleType" >
                                 <?php
