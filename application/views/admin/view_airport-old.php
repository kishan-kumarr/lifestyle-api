                            ...
                            <tr>
                               <td id="filter_col0" data-column="1">
                                 ...
                                 <td id="filter_col2" data-column="3">
                                  <input type="text" class="form-control column_filter" id="col3_filter" placeholder="State Name">
                                </td>
                                 <td id="filter_col3" data-column="4">
                                  <input type="text" class="form-control column_filter" id="col4_filter" placeholder="City Name">
                                </td>
                                 <td id="filter_col4" data-column="5">
                                  <input type="text" class="form-control column_filter" id="col5_filter" placeholder="Area Name">
                                </td>
                            </tr>
                      </table>
                    </div>
