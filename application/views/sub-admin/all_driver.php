          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-body">
                    <a href="<?= base_url('sub-admin-add-driver');?>" class="btn btn-rose pull-right" >Add Driver</a>
                  <div class="toolbar">
               <!-- Dependent filter -->
                      ...
                      <tbody>
                        ...
                        <tr>
                         ...
                         <td class="td-actions text-right">
                            <a href="<?= base_url('sub-admin-view-driver/').$val['id'];?>">
                            ...
                            <td class="td-actions text-right">
                             <a href="<?php if($val['status'] == '1' || $val['status']=='0') { echo 'javascript:void(0)';} else { echo base_url('sub-admin/Manage_driver/changeStatus/').$val['id'];}?>">
                              <?php 
                              if($val['status'] == '1'){ ?>
                              <button type="button" rel="tooltip" class="btn btn-success btn-round" data-original-title="" title="Appreved by Admin" >
                              <i class="fa fa-unlock" aria-hidden="true"></i>
                              </button>
                            <?php } else if($val['status'] == '2') { ?>
                              <button type="button" rel="tooltip" class="btn btn-warning btn-round" data-original-title="" title="change status">
                              <i class="fa fa-unlock" aria-hidden="true"></i>
                              </button>
                            <?php } else if($val['status'] == '3') { ?>
                                 <button type="button" rel="tooltip" class="btn btn-primary btn-round" data-original-title="" title="change status">
                                 <i class="fa fa-lock" aria-hidden="true"></i>
                              </button>
                            <?php } else { ?>
                                 <button type="button" rel="tooltip" class="btn btn-danger btn-round" data-original-title="" title="disapproved by admin">
                                 <i class="fa fa-lock" aria-hidden="true"></i>
                              </button>
                            <?php } ?>
                           </a>
                           ...
                           <a href="<?= base_url('sub-admin-update-driver/').$val['id'];?>">
                    ...
                    <div id="deleteModal<?= $val['id'] ; ?>" class="modal fade">
                       <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <!-- dialog buttons -->
                          <div class="modal-footer"><button type="button" class="btn btn-danger"  onclick="window.location.href='<?php echo base_url('sub-admin/Manage_driver/deleteDriver/'.$val['id']);?>';">Confirm</button> &nbsp;&nbsp;<button type="button" class="btn btn-primary" data-dismiss="modal">Close</button>
                          </div>
                        </div>
                       </div>
                     </div>
