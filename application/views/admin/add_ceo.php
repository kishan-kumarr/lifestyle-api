 <div class="content">
        <div class="container-fluid">
          <div class="row">
            ...
            <?php
             $formToken = uniqid();
             $this->session->set_userdata('formToken', $formToken);
             ?>
              <form id="RangeValidation" class="form-horizontal" action="<?= base_url('add-ceo');?>" method="post" enctype="multipart/form-data">
                <div class="card ">
                  <input type="hidden" name="formToken" value="<?= $formToken; ?>" >
                  <div class="card-header card-header-rose card-header-text">
                    <div class="card-text">
                      <h4 class="card-title">Add Ceo</h4>
                    </div>
                  </div>
                  <div class="card-body ">
