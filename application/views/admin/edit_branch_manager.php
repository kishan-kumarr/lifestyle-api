 <div class="content">
        <div class="container-fluid">
          <div class="row">
               <div class="col-md-12">
              <form id="RangeValidation" class="form-horizontal" action="<?= base_url('update-branch-manager/').$singleRecord['id'];?>" method="post" enctype="multipart/form-data">
                <div class="card ">
                          ...
                          <select class="selectpicker"  data-style="select-with-transition" title="Select CEO" id="ceo"  name="ceo" required="required" value="<?= set_value('ceo')?>">
                                <?php
                                  foreach($ceoList as $ceoName1)
                                    { ?>
                                  <option value="<?= $ceoName1['id'];?>" <?php if($singleRecord['under_ceo'] == $ceoName1['id']){ echo 'selected';}?>><?= $ceoName1['name'];?></option>
                                <?php } ?>
                            </select>
                            ...
                            <select class="selectpicker"  data-style="select-with-transition" title="Select Branch"  name="branch" required="required" value="<?= set_value('branch')?>">
                                   <?php
                                    foreach($branchList as $branch)
                                      { ?>
                                    <option value="<?= $branch['id'];?>" <?php if($singleRecord['branch'] == $branch['id']){ echo'selected';} ?>><?= $branch['branchName'];?></option>
                                  <?php } ?>
                                  </select>
