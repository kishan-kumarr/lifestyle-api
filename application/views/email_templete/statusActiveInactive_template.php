<?php
    $status   = ($mailData['status'] == 1) ? '<b>Approved</b>' : '<b>Disapproved</b>';
                     ...
                     <tr>
                        <td align="center">
                           ...
                           <table border="0" cellpadding="10" cellspacing="10" width="600" style="background: #fff; border:3px solid #ddd;">
                              <tbody>
                                 <tr>
                                    <td align="center" style="font-size: 30px; font-weight: bold; color: #222; letter-spacing: 1px; border-bottom:2px solid #115aa6;"><?= $subject;?></td>
                                 </tr>
                                 <tr>
                                    <td>
                                          ...
                                          <tbody>
                                             <tr>
                                                <td align="left">Hi <?= $UserName; ?> 
                                                  <br>Admin Has <?= $status; ?> Your Status. <br>
                                                   <?= ($mailData['status'] == 1) ? 'You can login into your account' : '';?> <br>
                                                </td>
                                             </tr>
                                          </tbody>
                                       </table>
