 <div class="content">
        <div class="container-fluid">
          <div class="row">
               <div class="col-md-12">
              <form id="RangeValidation" class="form-horizontal" action="<?= base_url('update-country/'.$singleRecord['id']);?>" method="post">
                <div class="card ">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-7">
                        <div class="form-group">
                          <input class="form-control" type="text" name="countryName"  required="required"  value="<?= $singleRecord['countryName'];?>"/>
