                ...
                <div class="card ">
                  ...
                  <div class="card-body ">
                   ...
                   <div class="row">
                      ...
                      <div class="col-sm-8">
                        <div class="form-group">
                          <div id="locationField">
                              <input id="locality" class="form-control" placeholder="Enter Airport Name" onkeyup="initializeAutocomplete()"  type="text" name="airportName" required="required" value="<?= $singleRecord['airportName']?>" />
                            </div>
                    ...
                    <input type="hidden" name="latitude" id="lat" value="<?= $singleRecord['latitude'];?>" >
                    <input type="hidden" name="langitude" id="lang" value="<?= $singleRecord['langitude'];?>" >
